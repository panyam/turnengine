...
export class GameViewerPage extends BasePage implements LCMComponent, GameViewerPageMethods {
    ...
    // Dockview interface
    protected dockview: DockviewApi;
     ...
     */
    protected initializeDockView(): void {
     ...
     */
    protected configureDefaultGameLayout(): void {
     ...
     */
    protected saveDockviewLayout(): void {
     ...
     */
    protected loadDockviewLayout(): any {
     ...
     */
    protected createMainGameComponent() {
     ...
     */
    protected createTerrainStatsComponent() {
     ...
     */
    protected createUnitStatsComponent() {
     ...
     */
    protected createTurnOptionsComponent() {
     ...
     */
    protected createDamageDistributionComponent() {
     ...
     */
    protected createGameLogComponent() {
...
GameViewerPage.loadAfterPageLoaded("gameViewerpage", GameViewerPage, "GameViewerPage")
